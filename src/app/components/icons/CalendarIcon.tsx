...
const CalendarIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
      <g>
          ...
          <path fill={navColors.navMorkGra} d="M0,23.5C0,23.776,0.224,24,0.5,24h23c0.276,0,0.5-0.224,0.5-0.5V8H0V23.5z M2.5,16C2.224,16,2,15.776,2,15.5
		...
		C2.224,20,2,19.776,2,19.5S2.224,19,2.5,19H6v-3H2.5z"/>
          <path fill={navColors.navMorkGra} d="M23.5,2H20V0.5C20,0.224,19.776,0,19.5,0h-3C16.224,0,16,0.224,16,0.5V2H8V0.5C8,0.224,7.776,0,7.5,0h-3
